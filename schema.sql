...
INSERT INTO `accredited_sellers` VALUES (1,2,'SARTE, JOHN CHRISTPOHER','johnchrist@gmail.com','09057545656','broker',NULL,1,NULL,'active','2024-12-31','2026-06-28 02:54:42','2026-06-28 02:54:42',8.00,8.00,8.00,NULL,NULL,NULL,NULL,1,'2026-06-28 10:54:42');
...
INSERT INTO `audit_logs` VALUES (1,1,'create','Projects','Created project Bailen Project','127.0.0.1','2026-06-28 02:39:06'),(2,1,'create','Projects','Created project Maragondon','127.0.0.1','2026-06-28 02:41:39'),(3,1,'create','Listings','Created listing LA-0416','127.0.0.1','2026-06-28 02:45:48'),(4,1,'delete','Listings','Deleted listing LA-0416','127.0.0.1','2026-06-28 02:47:00'),(5,1,'create','Listings','Created listing LA-0401','127.0.0.1','2026-06-28 02:47:47'),(6,1,'create','Listings','Created listing LA-LA-0416','127.0.0.1','2026-06-28 02:48:04'),(7,1,'create','Listings','Created listing LA-0402','127.0.0.1','2026-06-28 02:48:27'),(8,1,'create','Seller Groups','Created seller group SARTE, JOHN CHRISTOPHER GROUP','127.0.0.1','2026-06-28 02:51:20'),(9,1,'create','Seller Groups','Created seller group NORTH STAR GROUP','127.0.0.1','2026-06-28 02:51:55'),(10,1,'create','Users','Created user SARTE, JOHN CHRISTPOHER, linked seller profile 1, and resolved seller group automatically','127.0.0.1','2026-06-28 02:54:47');
...
--
-- Table structure for table `client_document_files`
--

DROP TABLE IF EXISTS `client_document_files`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `client_document_files` (
  `id` int NOT NULL AUTO_INCREMENT,
  `client_document_id` int NOT NULL,
  ...
  `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `idx_client_document_files_client_document_id` (`client_document_id`),
  KEY `idx_client_document_files_client_unit_id` (`client_unit_id`),
  KEY `idx_client_document_files_document_id` (`document_id`),
  KEY `idx_client_document_files_uploaded_by` (`uploaded_by`),
  KEY `idx_client_document_files_status` (`file_status`),
  KEY `idx_doc_files_unit_status_uploaded` (`client_unit_id`,`file_status`,`uploaded_at`),
  CONSTRAINT `fk_client_document_files_client_document` FOREIGN KEY (`client_document_id`) REFERENCES `client_document_list` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_client_document_files_client_unit` FOREIGN KEY (`client_unit_id`) REFERENCES `client_units` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_client_document_files_document` FOREIGN KEY (`document_id`) REFERENCES `documents` (`id`),
  CONSTRAINT `fk_client_document_files_uploaded_by` FOREIGN KEY (`uploaded_by`) REFERENCES `users` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `client_document_files`
--

LOCK TABLES `client_document_files` WRITE;
/*!40000 ALTER TABLE `client_document_files` DISABLE KEYS */;
/*!40000 ALTER TABLE `client_document_files` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `client_document_list` (
  ...
  KEY `idx_docs_unit_status_required` (`client_unit_id`,`status`,`is_required`),
  KEY `idx_docs_status_required` (`status`,`is_required`),
...
CREATE TABLE `client_unit_cancellation_settlements` (
  ...
  `contract_price_snapshot` decimal(15,2) NOT NULL DEFAULT '0.00',
...
CREATE TABLE `client_units` (
  ...
  `legal_misc_payment_mode` enum('included','deferred') NOT NULL DEFAULT 'included',
  `defer_legal_misc_fee` tinyint(1) NOT NULL DEFAULT '0',
  `legal_misc_due_date` date DEFAULT NULL,
  `legal_misc_deferred_amount` decimal(15,2) NOT NULL DEFAULT '0.00',
  ...
  `cancelled_contract_price` decimal(15,2) NOT NULL DEFAULT '0.00',
  `cancelled_total_paid` decimal(15,2) NOT NULL DEFAULT '0.00',
  `cancelled_balance_snapshot` decimal(15,2) NOT NULL DEFAULT '0.00',
  ...
  KEY `idx_client_units_legal_misc_payment_mode` (`legal_misc_payment_mode`),
...
CREATE TABLE `commission_releases` (
  ...
  KEY `idx_releases_status_commission` (`status`,`commission_id`),
  KEY `idx_releases_released_at_status` (`released_at`,`status`),
  KEY `idx_releases_commission_status` (`commission_id`,`status`),
...
CREATE TABLE `commissions` (
  ...
  KEY `idx_commissions_seller_status_created` (`seller_id`,`status`,`created_at`),
  KEY `idx_commissions_unit_status` (`client_unit_id`,`status`),
  KEY `idx_commissions_status_created_id` (`status`,`created_at`,`id`),
...
INSERT INTO `document_template_items` VALUES (1,1,1,1,'active',1,'2026-06-28 02:35:52','2026-06-28 02:35:52'),(2,1,2,1,'active',2,'2026-06-28 02:35:52','2026-06-28 02:35:52'),(3,1,3,1,'active',3,'2026-06-28 02:35:52','2026-06-28 02:35:52'),(4,1,4,1,'active',4,'2026-06-28 02:35:52','2026-06-28 02:35:52'),(5,1,5,1,'active',5,'2026-06-28 02:35:52','2026-06-28 02:35:52'),(6,1,6,1,'active',6,'2026-06-28 02:35:52','2026-06-28 02:35:52'),(7,1,7,1,'active',7,'2026-06-28 02:35:52','2026-06-28 02:35:52'),(8,1,8,1,'active',8,'2026-06-28 02:35:52','2026-06-28 02:35:52'),(9,1,9,1,'active',9,'2026-06-28 02:35:52','2026-06-28 02:35:52'),(10,1,10,1,'active',10,'2026-06-28 02:35:52','2026-06-28 02:35:52'),(11,1,11,1,'active',11,'2026-06-28 02:35:52','2026-06-28 02:35:52'),(12,2,12,1,'active',1,'2026-06-28 02:35:52','2026-06-28 02:35:52'),(13,2,13,1,'active',2,'2026-06-28 02:35:52','2026-06-28 02:35:52'),(14,3,14,1,'active',1,'2026-06-28 02:35:52','2026-06-28 02:35:52'),(15,3,15,1,'active',2,'2026-06-28 02:35:52','2026-06-28 02:35:52'),(16,3,16,1,'active',3,'2026-06-28 02:35:52','2026-06-28 02:35:52'),(17,4,17,1,'active',1,'2026-06-28 02:35:52','2026-06-28 02:35:52'),(18,4,18,1,'active',2,'2026-06-28 02:35:52','2026-06-28 02:35:52'),(19,4,19,1,'active',3,'2026-06-28 02:35:52','2026-06-28 02:35:52'),(20,4,20,1,'active',4,'2026-06-28 02:35:52','2026-06-28 02:35:52'),(21,5,21,1,'active',1,'2026-06-28 02:35:52','2026-06-28 02:35:52'),(22,5,22,1,'active',2,'2026-06-28 02:35:52','2026-06-28 02:35:52');
...
INSERT INTO `document_templates` VALUES (1,'LIST OF DOCUMENTS',NULL,'active',NULL,'2026-06-28 02:35:52','2026-06-28 02:35:52'),(2,'FOR OFW\'s',NULL,'active',NULL,'2026-06-28 02:35:52','2026-06-28 02:35:52'),(3,'Required for Submission',NULL,'active',NULL,'2026-06-28 02:35:52','2026-06-28 02:35:52'),(4,'Required for Submission(For Married Client\'s)',NULL,'active',NULL,'2026-06-28 02:35:52','2026-06-28 02:35:52'),(5,'Required for Submission(For OFW\'s or Representative)',NULL,'active',NULL,'2026-06-28 02:35:52','2026-06-28 02:35:52');
...
INSERT INTO `documents` VALUES (1,'CLIENT REGISTRATION FORM (Seller\'s Copy)',NULL,0,1,'active','2026-06-28 02:35:52','2026-06-28 02:35:52'),(2,'CLIENT REGISTRATION FORM (Administrator Copy)',NULL,0,1,'active','2026-06-28 02:35:52','2026-06-28 02:35:52'),(3,'BUYER\'S INFORMATION FORM',NULL,0,1,'active','2026-06-28 02:35:52','2026-06-28 02:35:52'),(4,'INTENT TO BUY',NULL,0,1,'active','2026-06-28 02:35:52','2026-06-28 02:35:52'),(5,'OFFER TO BUT & BUYER\'S PROFILE',NULL,0,1,'active','2026-06-28 02:35:52','2026-06-28 02:35:52'),(6,'RESERVATION AGREEMENT',NULL,0,1,'active','2026-06-28 02:35:52','2026-06-28 02:35:52'),(7,'DEED OF SALE',NULL,0,1,'active','2026-06-28 02:35:52','2026-06-28 02:35:52'),(8,'CONTRACT TO SELL',NULL,0,1,'active','2026-06-28 02:35:52','2026-06-28 02:35:52'),(9,'BUYER COUNSELLING AND ACKNOWLEDGEMENT FORM',NULL,0,1,'active','2026-06-28 02:35:52','2026-06-28 02:35:52'),(10,'VOLUNTARY CANCELLATION AND WAIVER OF RIGHTS',NULL,0,1,'active','2026-06-28 02:35:52','2026-06-28 02:35:52'),(11,'BUYER ACKNOWLEDGEMENT FORM',NULL,0,1,'active','2026-06-28 02:35:52','2026-06-28 02:35:52'),(12,'SPA to Process Title (for Company)',NULL,0,1,'active','2026-06-28 02:35:52','2026-06-28 02:35:52'),(13,'SPA Authorization to Sign (for Representative)',NULL,0,1,'active','2026-06-28 02:35:52','2026-06-28 02:35:52'),(14,'Two valid Government-issued ID\'s (w/ 3 specimen signatures)',NULL,0,1,'active','2026-06-28 02:35:52','2026-06-28 02:35:52'),(15,'TIN No. / TIN ID',NULL,0,1,'active','2026-06-28 02:35:52','2026-06-28 02:35:52'),(16,'PSA (Single)',NULL,0,1,'active','2026-06-28 02:35:52','2026-06-28 02:35:52'),(17,'Marriage Certificate',NULL,0,1,'active','2026-06-28 02:35:52','2026-06-28 02:35:52'),(18,'Valid ID of Spouse (w/ 3 specimen signatures)',NULL,0,1,'active','2026-06-28 02:35:52','2026-06-28 02:35:52'),(19,'Spouse\'s Signature (when required)',NULL,0,1,'active','2026-06-28 02:35:52','2026-06-28 02:35:52'),(20,'CENOMAR (if the buyer has kids but not married)',NULL,0,1,'active','2026-06-28 02:35:52','2026-06-28 02:35:52'),(21,'Passport ID',NULL,0,1,'active','2026-06-28 02:35:52','2026-06-28 02:35:52'),(22,'Valid ID\'s of both Principal and Representative',NULL,0,1,'active','2026-06-28 02:35:52','2026-06-28 02:35:52');
...
INSERT INTO `listing_document_requirements` VALUES (15,2,14,1,'active',1,'listing_override','2026-06-28 02:47:47','2026-06-28 02:47:47'),(16,2,15,1,'active',2,'listing_override','2026-06-28 02:47:47','2026-06-28 02:47:47'),(17,2,16,1,'active',3,'listing_override','2026-06-28 02:47:47','2026-06-28 02:47:47'),(18,2,1,1,'active',4,'listing_override','2026-06-28 02:47:47','2026-06-28 02:47:47'),(19,2,2,1,'active',5,'listing_override','2026-06-28 02:47:47','2026-06-28 02:47:47'),(20,2,3,1,'active',6,'listing_override','2026-06-28 02:47:47','2026-06-28 02:47:47'),(21,2,4,1,'active',7,'listing_override','2026-06-28 02:47:47','2026-06-28 02:47:47'),(22,2,5,1,'active',8,'listing_override','2026-06-28 02:47:47','2026-06-28 02:47:47'),(23,2,6,1,'active',9,'listing_override','2026-06-28 02:47:47','2026-06-28 02:47:47'),(24,2,7,1,'active',10,'listing_override','2026-06-28 02:47:47','2026-06-28 02:47:47'),(25,2,8,1,'active',11,'listing_override','2026-06-28 02:47:47','2026-06-28 02:47:47'),(26,2,9,1,'active',12,'listing_override','2026-06-28 02:47:47','2026-06-28 02:47:47'),(27,2,10,1,'active',13,'listing_override','2026-06-28 02:47:47','2026-06-28 02:47:47'),(28,2,11,1,'active',14,'listing_override','2026-06-28 02:47:47','2026-06-28 02:47:47'),(29,3,14,1,'active',1,'project_default','2026-06-28 02:48:04','2026-06-28 02:48:04'),(30,3,15,1,'active',2,'project_default','2026-06-28 02:48:04','2026-06-28 02:48:04'),(31,3,16,1,'active',3,'project_default','2026-06-28 02:48:04','2026-06-28 02:48:04'),(32,3,1,1,'active',4,'project_default','2026-06-28 02:48:04','2026-06-28 02:48:04'),(33,3,2,1,'active',5,'project_default','2026-06-28 02:48:04','2026-06-28 02:48:04'),(34,3,3,1,'active',6,'project_default','2026-06-28 02:48:04','2026-06-28 02:48:04'),(35,3,4,1,'active',7,'project_default','2026-06-28 02:48:04','2026-06-28 02:48:04'),(36,3,5,1,'active',8,'project_default','2026-06-28 02:48:04','2026-06-28 02:48:04'),(37,3,6,1,'active',9,'project_default','2026-06-28 02:48:04','2026-06-28 02:48:04'),(38,3,7,1,'active',10,'project_default','2026-06-28 02:48:04','2026-06-28 02:48:04'),(39,3,8,1,'active',11,'project_default','2026-06-28 02:48:04','2026-06-28 02:48:04'),(40,3,9,1,'active',12,'project_default','2026-06-28 02:48:04','2026-06-28 02:48:04'),(41,3,10,1,'active',13,'project_default','2026-06-28 02:48:04','2026-06-28 02:48:04'),(42,3,11,1,'active',14,'project_default','2026-06-28 02:48:04','2026-06-28 02:48:04'),(44,4,14,1,'active',1,'listing_override','2026-06-28 02:48:27','2026-06-28 02:48:27'),(45,4,15,1,'active',2,'listing_override','2026-06-28 02:48:27','2026-06-28 02:48:27'),(46,4,16,1,'active',3,'listing_override','2026-06-28 02:48:27','2026-06-28 02:48:27'),(47,4,1,1,'active',4,'listing_override','2026-06-28 02:48:27','2026-06-28 02:48:27'),(48,4,2,1,'active',5,'listing_override','2026-06-28 02:48:27','2026-06-28 02:48:27'),(49,4,3,1,'active',6,'listing_override','2026-06-28 02:48:27','2026-06-28 02:48:27'),(50,4,4,1,'active',7,'listing_override','2026-06-28 02:48:27','2026-06-28 02:48:27'),(51,4,5,1,'active',8,'listing_override','2026-06-28 02:48:27','2026-06-28 02:48:27'),(52,4,6,1,'active',9,'listing_override','2026-06-28 02:48:27','2026-06-28 02:48:27'),(53,4,7,1,'active',10,'listing_override','2026-06-28 02:48:27','2026-06-28 02:48:27'),(54,4,8,1,'active',11,'listing_override','2026-06-28 02:48:27','2026-06-28 02:48:27'),(55,4,9,1,'active',12,'listing_override','2026-06-28 02:48:27','2026-06-28 02:48:27'),(56,4,10,1,'active',13,'listing_override','2026-06-28 02:48:27','2026-06-28 02:48:27'),(57,4,11,1,'active',14,'listing_override','2026-06-28 02:48:27','2026-06-28 02:48:27');
...
INSERT INTO `listings` (`id`, `project_id`, `cadastral_lot_no`, `unit_id`, `block_no`, `lot_no`, `orientation`, `lot_type`, `reservation_fee`, `price_per_sqm`, `lot_area_sqm`, `legal_misc_rate`, `annual_interest_rate`, `status`, `created_at`, `updated_at`) VALUES (2,1,'1306','LA-0401',NULL,NULL,NULL,'inner',50000.00,1200.00,300.00,10.00,0.000,'available','2026-06-28 02:47:47','2026-06-28 02:47:47'),(3,1,'1306','LA-LA-0416',NULL,NULL,NULL,'inner',50000.00,1200.00,300.00,10.00,0.000,'available','2026-06-28 02:48:04','2026-06-28 02:48:04'),(4,1,NULL,'LA-0402',NULL,NULL,NULL,'inner',50000.00,1200.00,300.00,10.00,0.000,'available','2026-06-28 02:48:27','2026-06-28 02:48:27');
...
CREATE TABLE `payment_schedules` (
  ...
  KEY `idx_sched_unit_status_due` (`client_unit_id`,`status`,`due_date`),
  KEY `idx_sched_status_due_unit` (`status`,`due_date`,`client_unit_id`),
  KEY `idx_sched_unit_sort` (`client_unit_id`,`sort_order`),
...
CREATE TABLE `payments` (
  ...
  KEY `idx_payments_status_date_id` (`status`,`payment_date`,`id`),
  KEY `idx_payments_unit_date_id` (`client_unit_id`,`payment_date`,`id`),
  KEY `idx_payments_type_status_date` (`payment_type`,`status`,`payment_date`),
...
INSERT INTO `project_cadastral_lots` VALUES (1,1,'1306','active','2026-06-28 02:39:06','2026-06-28 02:39:06'),(2,1,'1314','active','2026-06-28 02:39:06','2026-06-28 02:39:06');
...
INSERT INTO `project_document_requirements` VALUES (1,1,14,1,'active',1,'2026-06-28 02:39:06','2026-06-28 02:39:06'),(2,1,15,1,'active',2,'2026-06-28 02:39:06','2026-06-28 02:39:06'),(3,1,16,1,'active',3,'2026-06-28 02:39:06','2026-06-28 02:39:06'),(4,1,1,1,'active',4,'2026-06-28 02:39:06','2026-06-28 02:39:06'),(5,1,2,1,'active',5,'2026-06-28 02:39:06','2026-06-28 02:39:06'),(6,1,3,1,'active',6,'2026-06-28 02:39:06','2026-06-28 02:39:06'),(7,1,4,1,'active',7,'2026-06-28 02:39:06','2026-06-28 02:39:06'),(8,1,5,1,'active',8,'2026-06-28 02:39:06','2026-06-28 02:39:06'),(9,1,6,1,'active',9,'2026-06-28 02:39:06','2026-06-28 02:39:06'),(10,1,7,1,'active',10,'2026-06-28 02:39:06','2026-06-28 02:39:06'),(11,1,8,1,'active',11,'2026-06-28 02:39:06','2026-06-28 02:39:06'),(12,1,9,1,'active',12,'2026-06-28 02:39:06','2026-06-28 02:39:06'),(13,1,10,1,'active',13,'2026-06-28 02:39:06','2026-06-28 02:39:06'),(14,1,11,1,'active',14,'2026-06-28 02:39:06','2026-06-28 02:39:06'),(15,2,14,1,'active',1,'2026-06-28 02:41:39','2026-06-28 02:41:39'),(16,2,15,1,'active',2,'2026-06-28 02:41:39','2026-06-28 02:41:39'),(17,2,16,1,'active',3,'2026-06-28 02:41:39','2026-06-28 02:41:39'),(18,2,1,1,'active',4,'2026-06-28 02:41:39','2026-06-28 02:41:39'),(19,2,2,1,'active',5,'2026-06-28 02:41:39','2026-06-28 02:41:39'),(20,2,3,1,'active',6,'2026-06-28 02:41:39','2026-06-28 02:41:39'),(21,2,4,1,'active',7,'2026-06-28 02:41:39','2026-06-28 02:41:39'),(22,2,5,1,'active',8,'2026-06-28 02:41:39','2026-06-28 02:41:39'),(23,2,6,1,'active',9,'2026-06-28 02:41:39','2026-06-28 02:41:39'),(24,2,7,1,'active',10,'2026-06-28 02:41:39','2026-06-28 02:41:39'),(25,2,8,1,'active',11,'2026-06-28 02:41:39','2026-06-28 02:41:39'),(26,2,9,1,'active',12,'2026-06-28 02:41:39','2026-06-28 02:41:39'),(27,2,10,1,'active',13,'2026-06-28 02:41:39','2026-06-28 02:41:39'),(28,2,11,1,'active',14,'2026-06-28 02:41:39','2026-06-28 02:41:39');
...
INSERT INTO `projects` VALUES (1,'Bailen Project','Bailen, Cavite','LA','IMELDA B. VILLALOBOS','AA-06-0005-00105','022-06-0005-003-04','active',3,NULL,'2026-06-28 02:39:06','2026-06-28 02:39:06'),(2,'Maragondon','Maragondon, Cavite','PE','SANTOS VILLAMOR','AE-02-0205-002323','022-03-0002-002-01','active',3,NULL,'2026-06-28 02:41:39','2026-06-28 02:41:39');
...
INSERT INTO `seller_group_members` VALUES (1,1,1,'active','2026-06-28 10:54:42',NULL,'2026-06-28 02:54:42','2026-06-28 02:54:42');
...
INSERT INTO `seller_group_rate_distributions` VALUES (1,1,'broker_network_manager',8.00,8.00,'approved','Editable rate for BNM personal sale.',1,'2026-06-28 02:51:20','2026-06-28 02:51:20'),(2,1,'broker',8.00,8.00,'approved','Editable broker personal sale rate.',1,'2026-06-28 02:51:20','2026-06-28 02:51:20'),(3,1,'manager',7.00,7.00,'approved','Editable manager personal sale rate.',1,'2026-06-28 02:51:20','2026-06-28 02:51:20'),(4,1,'agent',5.00,5.00,'approved','Editable agent personal sale rate.',1,'2026-06-28 02:51:20','2026-06-28 02:51:20'),(5,2,'broker_network_manager',8.00,8.00,'approved','Editable rate for BNM personal sale.',1,'2026-06-28 02:51:55','2026-06-28 02:51:55'),(6,2,'broker',7.00,7.00,'approved','Editable broker personal sale rate.',1,'2026-06-28 02:51:55','2026-06-28 02:51:55'),(7,2,'manager',5.00,5.00,'approved','Editable manager personal sale rate.',1,'2026-06-28 02:51:55','2026-06-28 02:51:55'),(8,2,'agent',3.00,3.00,'approved','Editable agent personal sale rate.',1,'2026-06-28 02:51:55','2026-06-28 02:51:55');
...
INSERT INTO `seller_groups` VALUES (1,'SARTE, JOHN CHRISTOPHER GROUP',NULL,8.00,5.00,0.00,1.00,2.00,'{\"agent\": 5, \"broker\": 1, \"manager\": 2, \"broker_network_manager\": 0}','{\"broker\": 1, \"manager\": 7, \"broker_network_manager\": 0}','{\"broker\": 8, \"broker_network_manager\": 0}','{\"broker_network_manager\": 8}','custom_sale_type_splits',NULL,'active',NULL,1,1,'2026-06-28 02:51:20','2026-06-28 02:51:20'),(2,'NORTH STAR GROUP',NULL,8.00,3.00,1.00,2.00,2.00,'{\"agent\": 3, \"broker\": 2, \"manager\": 2, \"broker_network_manager\": 1}','{\"broker\": 2, \"manager\": 5, \"broker_network_manager\": 1}','{\"broker\": 7, \"broker_network_manager\": 1}','{\"broker_network_manager\": 8}','custom_sale_type_splits',NULL,'active',NULL,1,1,'2026-06-28 02:51:55','2026-06-28 02:51:55');
...
INSERT INTO `users` VALUES (1,'Super Admin','superadmin@gmail.com','$2b$10$NctIePlPkOKirDJpOSR5PemQyFQydpwRSK2uE2oTj5e1dmbpPwGGy','super_admin','active',0,NULL,NULL,'2026-06-28 10:35:52','2026-06-28 02:35:52','2026-06-28 02:35:52'),(2,'SARTE, JOHN CHRISTPOHER','johnchrist@gmail.com','password','broker','active',0,NULL,'2026-06-28 10:54:47',NULL,'2026-06-28 02:54:42','2026-06-28 02:57:42');
...
-- Dump completed on 2026-06-28 11:14:16
